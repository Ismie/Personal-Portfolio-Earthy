...
export const metadata: Metadata = {
  ...
  description: 'Datenschutzerklärung von romanschulz.com.',
};

export default function DatenschutzPage() {
  return (
    <div className="page wrap post">
      <header className="page-head">
        <h1>datenschutz<span className="dot">.</span></h1>
      </header>
      ...
      <div className="post-body">
        ...
        <p>
          ...
          Beschwerderecht bei der zuständigen Aufsichtsbehörde zu. Hierzu sowie zu weiteren Fragen
        ...
        <h3>Externes Hosting (Netlify)</h3>
        <p>
          Diese Website wird extern bei Netlify gehostet. Anbieter ist die Netlify, Inc., San
          Francisco, California, USA (nachfolgend {'„Netlify"'}). Die personenbezogenen Daten, die auf
          dieser Website erfasst werden, werden auf den Servern von Netlify gespeichert. Hierbei
        ...
        <p>
          Eine Verarbeitung kann auch in den USA stattfinden. Die Übermittlung in die USA wird auf
          Grundlage der EU-Standardvertragsklauseln und – soweit einschlägig – des EU-U.S. Data
          Privacy Framework abgesichert. Wir haben mit Netlify einen Vertrag über Auftragsverarbeitung
          (AVV/DPA) geschlossen, der gewährleistet, dass dieser die personenbezogenen Daten unserer
          Websitebesucher nur nach unseren Weisungen und unter Einhaltung der DSGVO verarbeitet.
        </p>
        <p>
          Hinweis: Die Domain romanschulz.com ist bei der HOSTINGER operations, UAB (Švitrigailos
          str. 34, 03230 Vilnius, Litauen) registriert. Die Registrierstelle verarbeitet keine
          Inhalts- oder Nutzungsdaten dieser Website.
        </p>
        ...
        <p>
          Roman Schulz<br />
          Clara-Schumann-Straße 7<br />
          58675 Hemer
          <br />
          <br />
          Telefon: +49 159 05301529<br />
          E-Mail: kontakt@romanschulz.com
        </p>
        <p>
        ...
        <p>
          ...
          Auftragsverarbeitern geben wir personenbezogene Daten nur auf Grundlage eines gültigen
          Vertrags über Auftragsverarbeitung weiter. Im Falle einer gemeinsamen Verarbeitung wird
        ...
        <p>
          ...
          dem Formular (Name, E-Mail-Adresse, Betreff und Nachricht) inklusive der von Ihnen dort
          angegebenen Kontaktdaten zwecks Bearbeitung der Anfrage und für den Fall von
          Anschlussfragen bei uns gespeichert und verarbeitet. Diese Daten geben wir nicht ohne Ihre
          Einwilligung weiter.
        </p>
        <p>
        ...
        <p>
          Die von Ihnen über das Kontaktformular übersandten Daten verbleiben bei uns, bis Sie uns
        ...
        <h3>Versanddienstleister {'„Resend"'}</h3>
        <p>
          Für die technische Zustellung der über unser Kontaktformular eingehenden Nachrichten
          setzen wir den E-Mail-Dienst Resend der Resend, Inc., USA, ein. Wenn Sie das
          Kontaktformular absenden, werden die eingegebenen Daten (Name, E-Mail-Adresse, Betreff,
          Nachricht) an Resend übermittelt und dort ausschließlich zum Zweck der Zustellung der
          E-Mail verarbeitet. Rechtsgrundlage ist unser berechtigtes Interesse an einer
          zuverlässigen Zustellung der Kontaktanfragen (Art. 6 Abs. 1 lit. f DSGVO) bzw. Art. 6 Abs.
          1 lit. b DSGVO. Eine Verarbeitung kann auch in den USA stattfinden; die Übermittlung wird
          auf Grundlage der EU-Standardvertragsklauseln abgesichert. Mit Resend besteht ein Vertrag
